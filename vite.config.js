  ...
  build: {
    rollupOptions: {
      input: {
        ...
        buttons: resolve(__dirname, './pages/ui/buttons.html'),
        checkbox: resolve(__dirname, './pages/forms/checkbox.html'),
        input: resolve(__dirname, './pages/forms/input.html'),
        radio: resolve(__dirname, './pages/forms/radio.html'),
        select: resolve(__dirname, './pages/forms/select.html'),
        switch: resolve(__dirname, './pages/forms/switch.html'),
        textarea: resolve(__dirname, './pages/forms/textarea.html'),
        ...
        layout: resolve(__dirname, './pages/forms/layout.html'),
        ...
        cards: resolve(__dirname, './pages/ui/cards.html'),
        tabs: resolve(__dirname, './pages/ui/tabs.html'),
        accordions: resolve(__dirname, './pages/ui/accordions.html'),
